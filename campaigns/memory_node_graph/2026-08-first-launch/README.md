...
| `generated/x-thread.md` | X 4개 구간 스레드 |
| `generated/threads-series.md` | Threads Build in Public 연속 게시 |
...
| `generated/dev-article.md` | DEV 기술 글 보강 작업본 |
| `generated/youtube-shorts.md` | Shorts 제목·설명·20초 샷리스트 |
| `generated/show-hn.md` | Show HN 사람 검토용 영어 작업본·게이트 |
...
1. 첫 게시에는 `final/geeknews-show.md`와 대표 이미지를 사용합니다.
2. 운영자 본인의 말투로 제목과 본문을 마지막으로 검토합니다.
